...
-- If the customer rented a movie this month (JUNE/2005) (not working)
...
LEFT JOIN query4 as table_query4 on table_query3.customer_id = table_query4.customer_id
LEFT JOIN query5 as table_query5 on table_query4.customer_id = table_query5.customer_id
